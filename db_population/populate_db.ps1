...
python utils\inject_uuid_correct_date.py .\unprocessed-collections\company-collection.json .\unprocessed-collections\po-collection.json purchaseOrder .\processed-collections\po-collection.json 2
python utils\inject_uuid_correct_date.py .\unprocessed-collections\company-collection.json .\unprocessed-collections\invoice-collection.json invoice .\processed-collections\invoice-collection.json 3

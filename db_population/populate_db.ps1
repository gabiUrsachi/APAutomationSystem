...
mongoimport --db=APsystem --collection=company --uri=mongodb://34.234.67.141:27017  --jsonArray .\processed-collections\company-collection.json 
mongoimport --db=APsystem --collection=purchaseOrder --uri=mongodb://34.234.67.141:27017  --jsonArray .\processed-collections\po-collection.json
mongoimport --db=APsystem --collection=invoice --uri=mongodb://34.234.67.141:27017  --jsonArray .\processed-collections\invoice-collection.json

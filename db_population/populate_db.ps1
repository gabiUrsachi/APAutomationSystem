...
Write-Host "assigning company uuid for po and invoice transactions"
...
mongoimport --db=APsystem --collection=company --uri=mongodb://18.207.247.177:27017  --jsonArray .\processed-collections\company-collection.json 
mongoimport --db=APsystem --collection=purchaseOrder --uri=mongodb://18.207.247.177:27017  --jsonArray .\processed-collections\po-collection.json
mongoimport --db=APsystem --collection=invoice --uri=mongodb://18.207.247.177:27017  --jsonArray .\processed-collections\invoice-collection.json

...
mongoimport --db=APsystem --collection=company --uri=mongodb://54.198.160.244:27017  --jsonArray .\processed-collections\company-collection.json 
mongoimport --db=APsystem --collection=purchaseOrder --uri=mongodb://54.198.160.244:27017  --jsonArray .\processed-collections\po-collection.json
mongoimport --db=APsystem --collection=invoice --uri=mongodb://54.198.160.244:27017  --jsonArray .\processed-collections\invoice-collection.json
